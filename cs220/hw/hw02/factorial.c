...
int main(int argc, char **argv) {
	...
	printf("%d! does not fit in a short integer variable\n",i_short);
	...
	printf("%d! does not fit in an integer variable\n",i_int);
	...
	printf("%ld! does not fit in a long integer variable\n",i_long);
	...
	for(i_float=1; ; i_float++) {
		...
		/*if ((int)i_float >=2 && 0 != (int)r_float%2 ) break; 
		if ((int)i_float >=5 && 0 != (int)r_float%10) break; */
		if (r_float == INFINITY) break; 
		printf("%f! = %g\n",i_float,r_float);
	}
	printf("%f! does not fit in a floating point variable\n",i_float);
	...
	for(i_double=1; ; i_double++) {
		...
		/*if ((int)i_double >=2 && 0 != (int)r_double%2 ) break; 
		if ((int)i_double >=5 && 0 != (int)r_double%10) break; */
